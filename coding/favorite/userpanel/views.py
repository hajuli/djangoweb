...
from talkboard.userpanel.forms import LoginForm, SignupForm, EditForm, AvatarForm,\
    UpdatePswdForm
from django.contrib.auth import REDIRECT_FIELD_NAME
from django.http import HttpResponseRedirect
from django.contrib.auth.decorators import login_required
from talkboard.utils import ImageUtils
from talkboard.utils.CommonUtils import get_base_context_map


def signup(request, next_page=None):
    return HttpResponseRedirect(next_page or '/favorite/')
